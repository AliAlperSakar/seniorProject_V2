									...
									<li style={{ width: "300px" }}>
										<a style={{ height: "auto" }}>
											<div style={{ float: "left", display: "block" }}>
												<p style={{ fontSize: "16px",marginLeft:10 }}><img style={{width: "12%" }} className="sportIcon" src={sportCenterIcon} />Sport Halls<Icon name="angle double down" /></p>
												
											</div>
										</a>
									</li>
									<li style={{ fontSize:"16px" }}><a>Gallery</a></li>
									...
									x.id < 6 ?
										<Link to={href + index}>
											<div className='specialtr' style={{ width: "20%"}} key={x.id}>
												...
												<p style={{ maxHeight: "20%" }}>Lorem Ipsum, dizgi ve baskı endüstrisinde kullanılan mıgır metinlerdir. Lorem Ipsum, adı bilinmeyen bir matbaacının bir hurufat numune kitabı oluşturmak üzere bir yazı galerisini alarak karıştırdığı 1500'lerden beri endüstri standardı sahte metinler olarak kullanılmıştır. </p>
											</div>
										</Link>
										: <div></div>
								)
